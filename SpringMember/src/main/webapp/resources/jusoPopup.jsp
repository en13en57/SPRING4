...
function init(){
	...
	var confmKey = "U01TX0FVVEgyMDE2MTEwMjEwMTY0OTE2MjA5";
...
<body onload="init();">
	<form id="form" name="form" method="post">
		<input type="hidden" id="confmKey" name="confmKey" value="U01TX0FVVEgyMDE2MTEwMjEwMTY0OTE2MjA5"/>
		<input type="hidden" id="returnUrl" name="returnUrl" value="http://localhost:8080/member/resources/Sample.jsp"/>
